...
const SHORTCUT_TABLE: ShortcutRow[] = [
  ...
  { keys: "Alt+1", action: "Set Plan mode", context: "Chat view (incl. composer)" },
  { keys: "Alt+2", action: "Set Build mode", context: "Chat view (incl. composer)" },
  { keys: "Alt+3", action: "Set Auto mode", context: "Chat view (incl. composer)" },
  { keys: "Alt+4", action: "Set Orchestrated mode", context: "Chat view (incl. composer)" },
  { keys: "Shift+Tab", action: "Cycle mode (Plan → Build → Auto → Orchestrated)", context: "Mode button focused" },
  { keys: "Alt+Shift+Tab", action: "Cycle mode (Plan → Build → Auto → Orchestrated)", context: "Chat view" },
  { keys: "Ctrl+Shift+M", action: "Cycle mode (Plan → Build → Auto → Orchestrated)", context: "Chat view" },
  { keys: "Ctrl/Cmd+L", action: "Focus prompt input", context: "Chat view" },
  { keys: "Enter", action: "Send (idle) · Queue a follow-up (while streaming)", context: "Prompt focused" },
  { keys: "Ctrl/Cmd+Enter", action: "Send (idle) · Interrupt & send now (while streaming)", context: "Prompt focused" },
  { keys: "Shift+Enter", action: "New line", context: "Prompt focused" },
