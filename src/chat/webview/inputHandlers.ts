...
export function createInputHandlers(deps: InputHandlerDeps): InputHandlers {
  ...
  function onInputKeydown(e: KeyboardEvent): void {
    if (e.ctrlKey || e.metaKey) {
      ...
      if (e.key === "t") { e.preventDefault(); createNewTab(); return }
      if (e.key === "w") { e.preventDefault(); const active = stateManager.getActiveSession(); if (active) closeTab(active.id); return }
