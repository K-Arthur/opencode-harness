/**
 * Session Status Mapper Tests (TDD Approach)
 * 
 * Tests written FIRST based on actual OpenCode server event structure from logs.
 * The actual structure from the logs:
 ...
 * 
 * This is DIFFERENT from SDK errors handled by opencodeErrorMapper.ts.
...
// We'll implement the mapper to make them pass

describe("Session Status Mapper - TDD Tests Based on Actual Server Events", () => {
