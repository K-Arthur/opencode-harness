...
| FM-CFG-027 | `opencode.tdd.minCoverage` | number | `80` | window | stable |
| FM-CFG-028 | `opencode.tdd.maxIterations` | number | `5` | window | stable |
| FM-CFG-029 | `opencode.sadd.enabled` | boolean | `false` | window | stable |
| FM-CFG-030 | `opencode.sadd.maxSubagents` | number | `4` | window | stable |
...
| FM-CFG-034 | `opencode.streaming.logToOutputChannel` | boolean | `true` | window | stable |
| FM-CFG-035 | `opencode.sessions.maxTabs` | number | `20` | window | stable |
...
| FM-CFG-038 | `opencode.chat.wrapLongLines` | enum | `"auto"` | window | stable |
